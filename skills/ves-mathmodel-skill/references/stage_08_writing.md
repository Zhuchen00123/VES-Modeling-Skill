...
- directly import or reference the structured experimental report generated by
  `scripts/render_ves_report.py` (`results/<Qi>_ves_report.md`), ensuring that code SHA-256
  and host verifier metrics match the physical evidence;
